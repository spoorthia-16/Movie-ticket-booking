...
const MovieDetails = () => {
  ...
  try {
    ...
    // Force toast to show even if message missing
    toast.success(data.message || "Favorite movies updated!");
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-20 md:pt-32'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <img src={image_base_url + show.movie.poster_path} alt="" className='max-md:mx-auto rounded-xl h-[420px] w-[280px] object-cover shadow-lg'/>
        ...
        <div className='relative flex flex-col gap-4'>
          ...
          <div className='flex gap-4 mt-4'>
            ...
            <button onClick={handleFavorite} className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-95'>
              <Heart className={`w-6 h-6 transition-all duration-200 ${favoriteMovies.find(movie => movie._id == id) ? "fill-primary text-primary" : "text-gray-300"}`}/>
            </button>
